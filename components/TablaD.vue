...
table.v-table tbody td:first-child, table.v-table thead th:first-child, table.v-table tbody th:first-child {
    padding: 0 5px;
}

table.v-table tbody td:not(:nth-child(1)), table.v-table thead th:not(:nth-child(1)) {
    padding: 0 5px;
}
